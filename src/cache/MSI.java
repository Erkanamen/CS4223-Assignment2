...
public class MSI extends AbstractCacheController {
	public MSI(int id, String file, int cacheSize, int associativity, int blockSize) throws Exception {
	...
	public void unstall(boolean shared) {
		...
		String unstallState = "";
		if (unstallAction == "PrRd") unstallState = "S";
		else unstallState = "M";
		if (index >= 0) {
